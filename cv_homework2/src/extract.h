...
{
public:
  Image2D() : img_(height, std::vector<int>(width, 0))
  , outline_(height, std::vector<int>(width, 0))
  , kernel_{}, f_(height, std::vector<double>(width, 0))
  , phi_(height, std::vector<double>(width, 0))
  , Gx_(height, std::vector<int>(width, 0))
  , Gy_(height, std::vector<int>(width, 0))
  , T_(30), A_(M_PI / 6)
  {}

  Image2D(double T, double A) :img_(height, std::vector<int>(width, 0))
  , outline_(height, std::vector<int>(width, 0))
  , kernel_{}, f_(height, std::vector<double>(width, 0))
  , phi_(height, std::vector<double>(width, 0))
  , Gx_(height, std::vector<int>(width, 0))
